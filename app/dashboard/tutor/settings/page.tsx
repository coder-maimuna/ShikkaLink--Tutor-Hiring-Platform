...
export default function TutorSettingsPage() {
  return (
    <div className="space-y-6 p-4 sm:p-6 lg:p-8">
      <div className="rounded-2xl border border-[#DCEFE2] bg-white p-6 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <h1 className="mt-2 text-2xl font-semibold text-[#1F2937]">Tutor account settings</h1>
          </div>
          <Link
      ...
      <div className="rounded-2xl border border-[#DCEFE2] bg-white p-6 shadow-sm">
        <p className="text-sm text-[#4B5563]">Notification and account management controls will appear here.</p>
      </div>
    </div>
  );
}
